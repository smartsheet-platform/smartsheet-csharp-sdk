...
namespace Smartsheet.Api.Internal
{
	...
	public class SheetColumnResourcesImpl : AbstractResources, SheetColumnResources
	{
		...
		public virtual DataWrapper<Column> ListColumns(long sheetId, IEnumerable<FilterInclusion> include, PaginationParameters paging)
		{
		...
		/// <exception cref="ServiceUnavailableException"> if the REST API service is not available (possibly due To rate limiting) </exception>
		/// <exception cref="SmartsheetException"> if there is any other error during the operation </exception>
		public virtual Column GetColumn(long sheetId, long columnId, IEnumerable<FilterInclusion> include)
		{
