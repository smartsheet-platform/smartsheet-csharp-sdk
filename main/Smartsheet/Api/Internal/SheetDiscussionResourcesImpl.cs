...
namespace Smartsheet.Api.Internal
{
	...
	public class SheetDiscussionResourcesImpl : AbstractResources, SheetDiscussionResources
	{
		...
		{
			return this.CreateResourceWithAttachment("sheets/" + sheetId, discussion, file, fileType);
		}
		...
		/// <exception cref="ServiceUnavailableException"> if the REST API service is not available (possibly due To rate limiting) </exception>
		/// <exception cref="SmartsheetException"> if there is any other error during the operation </exception>
		public virtual DataWrapper<Discussion> ListDiscussions(long sheetId, IEnumerable<DiscussionInclusion> include, PaginationParameters paging)
		{
