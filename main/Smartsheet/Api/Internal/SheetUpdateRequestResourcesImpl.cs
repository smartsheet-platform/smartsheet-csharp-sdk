...
namespace Smartsheet.Api.Internal
{
    public class SheetUpdateRequestResourcesImpl: AbstractResources, SheetUpdateRequestResources
    {
        ...
        public virtual PaginatedResult<UpdateRequest> ListUpdateRequests(long sheetId, PaginationParameters paging = null)
        {
        ...
        /// <exception cref="ServiceUnavailableException"> if the REST API service is not available (possibly due to rate limiting) </exception>
        /// <exception cref="SmartsheetException"> if there is any other error during the operation </exception>
        public virtual PaginatedResult<SentUpdateRequest> ListSentUpdateRequests(long sheetId, PaginationParameters paging = null)
        {
            IDictionary<string, string> parameters = new Dictionary<string, string>();
            if (paging != null)
            {
