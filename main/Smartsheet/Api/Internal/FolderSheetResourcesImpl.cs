...
namespace Smartsheet.Api.Internal
{
    ...
    public class FolderSheetResourcesImpl : AbstractResources, FolderSheetResources
    {
        ...
        /// <exception cref="ServiceUnavailableException"> if the REST API service is not available (possibly due to rate limiting) </exception>
        /// <exception cref="SmartsheetException"> if there is any other error during the operation </exception>
        public virtual Sheet CreateSheetFromTemplate(long folderId, Sheet sheet, IEnumerable<TemplateInclusion> includes = null)
        {
        ...
        /// <exception cref="ServiceUnavailableException"> if the REST API service is not available (possibly due to rate limiting) </exception>
        /// <exception cref="SmartsheetException"> if there is any other error during the operation </exception>
        public virtual Sheet ImportCsvSheet(long folderId, string file, string sheetName = null, int? headerRowIndex = null, int? primaryColumnIndex = null)
        {
        ...
        /// <exception cref="ServiceUnavailableException"> if the REST API service is not available (possibly due to rate limiting) </exception>
        /// <exception cref="SmartsheetException"> if there is any other error during the operation </exception>
        public virtual Sheet ImportXlsSheet(long folderId, string file, string sheetName = null, int? headerRowIndex = null, int? primaryColumnIndex = null)
        {
